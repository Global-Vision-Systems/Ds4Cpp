...
#define US_RUNTIME_OUTPUT_DIRECTORY             "."     // TODO be smarter!
#include <windows.h>
#include <strsafe.h>
#else
...
{
public:
    ModuleLoader() : m_Handle(0)
    {
    }

    ModuleLoader(const std::string& name, ModuleActivatorInstanceFunction activatorFunc = 0) : m_Name(name), m_ActivatorFunc(activatorFunc), m_Handle(0)
    {
    }
    ...
    static std::string GetLibraryPath()
    {
        ...
        // return std::string("E:/ds4cpp/ds4cpp/simple-launcher/ouput_cmake/Debug") ;
